...
if(isset($_POST['submit'])){
  ...
  $sql="UPDATE `employe` SET `ID`='$id',`MATRICULE`='$matricule',`NOM`='$nom',`PRENOM`='$prenom',`DATE`='$date',`DEPARTEMENT`='$departement',`SALAIRE`='$salaire',`FONCTION`='$fonction',`PHOTO`='$photo' WHERE id='$id'";
